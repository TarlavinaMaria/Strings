...
void main()
{
	...
	cout << "Если строка является целым числом, возвращает его значение: ";
	cout << delimiter << endl;

	cout << "Определяет, является ли строка двоичным числом: " << (Is_bin_number(str) ? "Да" : "Нет") << endl;
	cout << "Если строка является двоичным числом, возвращает его десятичное значение: ";
	cout << delimiter << endl;

	cout << "Определяет, является ли строка шестнадцатеричным числом: " << (Is_hex_number(str) ? "Да" : "Нет") << endl;
	cout << "Если строка является шестнадцатеричным числом, возвращает его десятичное значение: ";
